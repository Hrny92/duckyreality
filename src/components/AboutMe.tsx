        ...
        <div className="about-grid">
            ...
            <div style={{ position: 'absolute', inset: 0 }}>
              ...
              <div
                style={{
                  ...
                  background: 'rgba(0,43,64,0.88)', backdropFilter: 'blur(12px)',
              ...
              <div
                style={{
                  ...
                  background: '#e94e1b', color: '#fff', borderRadius: '1rem',
          ...
          <Reveal direction="right" delay={150} duration={800}>
            <div style={{ paddingTop: '1rem' }}>
              <h2 className="display-md" style={{ color: '#002b40', marginBottom: '2rem' }}>
                Makléř,&nbsp;<br />
                <span className="orange-word">kterému záleží.</span>
              </h2>

              <p style={{ fontSize: '1.05rem', lineHeight: 1.8, color: 'rgba(0,43,64,0.6)',
                ...
                {[
                  ...
                  <Reveal key={item} direction="up" delay={300 + i * 70} duration={500}>
                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.875rem' }}>
                      ...
                      <span style={{ fontSize: '0.9rem', fontWeight: 500, color: '#002b40', lineHeight: 1.6 }}>
                        {item}
                      </span>
                    </div>
                  </Reveal>
              ...
              <button
                ...
                style={{
                  ...
                  background: '#e94e1b', color: '#fff', fontWeight: 700, fontSize: '0.75rem',
