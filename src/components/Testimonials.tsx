...
export default function Testimonials() {
  ...
  return (
    <section id="reference" style={{ background: '#0A0A0A', padding: '8rem 0' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 2rem' }}>

        {/* ── Header ── */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', marginBottom: '5rem' }}>
          <span className="eyebrow" style={{ color: '#D4AF37', flexShrink: 0 }}>Reference</span>
          <div className="h-rule" style={{ flexGrow: 1 }} />
          <span style={{ fontSize: '0.75rem', fontWeight: 600, color: 'rgba(255,255,255,0.3)',
        ...
        <div className="testimonials-grid">
          ...
          <div style={{ position: 'sticky', top: '7rem', alignSelf: 'start' }}>
            {/* Uvozovka */}
            <div style={{ fontSize: '7rem', fontWeight: 900, color: '#D4AF37',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2.5rem' }}>
              ...
              <div style={{ display: 'flex', gap: 3, marginLeft: 'auto' }}>
                {[1,2,3,4,5].map(s => (
                  <svg key={s} width="14" height="14" viewBox="0 0 14 14" fill="#D4AF37">
            ...
            {reviews.map((rev, i) => (
              <button key={i} onClick={() => setActive(i)}
                ...
                <div style={{ width: 3, height: 32, borderRadius: 2, flexShrink: 0,
                  background: i === active ? '#D4AF37' : 'transparent',
                ...
                <div style={{ flex: 1, minWidth: 0, textAlign: 'left' }}>
                  ...
                  <div style={{ fontSize: '0.7rem', fontWeight: 500, marginTop: '0.1rem',
                    color: i === active ? 'rgba(255,255,255,0.4)' : 'rgba(255,255,255,0.2)',
                    transition: 'color 0.25s' }}>
                    {rev.date}
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', gap: 2, flexShrink: 0,
                  ...
                  {[1,2,3,4,5].map(s => (
                    <svg key={s} width="10" height="10" viewBox="0 0 14 14" fill="#D4AF37">
                      <path d="M7 1.5l1.5 3.5 3.8.5-2.8 2.6.7 3.8L7 10.1l-3.2 1.8.7-3.8-2.8-2.6 3.8-.5L7 1.5z"/>
                    </svg>
                  ))}
                </div>
