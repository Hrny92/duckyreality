      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 2rem' }}>
            ...
            <div key={p._id}>
              ...
              <Link href={`/nemovitosti/${p.slug.current}`}
                ...
                <div style={{ display: 'flex', alignItems: 'center', padding: '2rem 0',
                  ...
                  {/* Type pill */}
                  <div className="pill"
                    style={{ background: p.transactionType === 'prodej' ? 'rgba(212,175,55,0.15)' : 'rgba(255,255,255,0.08)',
        ...
        <div style={{ marginTop: '4rem', padding: '3rem', background: 'rgba(255,255,255,0.03)',
          ...
          <button onClick={openContactModal}
            ...
            onMouseEnter={e => { const el = e.currentTarget as HTMLElement; el.style.background='#D4AF37'; el.style.color='#fff' }}
